...
def foldergenerator(dir_to_create_folders, country, project, sitecode, infrastructure, date):
        ...
        if not os.path.exists(dirName):
            ...
            for t in range(0, len(processing)):
                ...
                for o in range(0, len(last3)):
                    ...
                    dirname4 = str(infrastructure[k]) + '/' + str(date) + '/' + '3DProcessing' + '/' + str(
                        photogram3[o])
                    ...
                    for b in range(0, len(processingfolders)):
                        ...
                        dirname5 = str(infrastructure[k]) + '/' + str(
                            date) + '/' + '3DProcessing' + '/' + 'Processing' + '/' + str(processingfolders[b])
                    ...
                    for e in range(0, len(rasterfolders)):
                        ...
                        dirname6 = str(infrastructure[k]) + '/' + str(
                            date) + '/' + '2DProcessing' + '/' + 'Rasters' + '/' + str(rasterfolders[e])
                    ...
                    for v in range(0, len(AcousticCorrectionFolders)):
                        ...
                        dirname6 = str(infrastructure[k]) + '/' + str(
                            date) + '/' + '3DProcessing' + '/' + 'Data' + '/' + 'acoustic' + '/' + str(
                            AcousticCorrectionFolders[v])
                    ...
                    for m in range(0, len(cloudsync)):
                        ...
                        dirname6 = str(infrastructure[k]) + '/' + str(
                            date) + '/' + '3DProcessing' + '/' + 'Output' + '/' + 'aws' + '/' + str(cloudsync[m])
